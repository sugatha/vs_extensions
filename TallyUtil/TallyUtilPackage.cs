...
namespace TallyUtil
{
    ...
    [Guid(TallyUtilPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    [ProvideMenuResource("Menus.ctmenu", 1)]
    [ProvideAutoLoad(VSConstants.UICONTEXT.NoSolution_string,PackageAutoLoadFlags.BackgroundLoad)]
    [ProvideAutoLoad(VSConstants.UICONTEXT.SolutionExists_string, PackageAutoLoadFlags.BackgroundLoad)]

    public sealed class TallyUtilPackage : AsyncPackage
    {
        /// <summary>
        /// TallyUtilPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "55d531bf-08bf-449e-a46a-96916825372e";

        /// <summary>
        /// Initializes a new instance of the <see cref="TallyUtilPackage"/> class.
        /// </summary>
        public TallyUtilPackage()
        {
