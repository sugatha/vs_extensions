    ...
    internal sealed class CreateProject
    {
        ...
        private void CreateProjectFileMacExe()
        {
            ...
            using (XmlWriter writer = XmlWriter.Create(szCurrPath + "\\" + szNewProjectName + "Mac" + ".vcxproj", settings))
            {
                ...
                WriteItemDefinitionGroup(writer, "Debug", "x64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
                WriteItemDefinitionGroup(writer, "Release", "x64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
                WriteItemDefinitionGroup(writer, "Diagnostics", "x64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
                WriteItemDefinitionGroup(writer, "SimulationOnly", "x64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
                WriteItemDefinitionGroup(writer, "TraceOnly", "x64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
                WriteItemDefinitionGroup(writer, "MetricsOnly", "x64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);

                WriteItemDefinitionGroup(writer, "Debug", "ARM64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
                WriteItemDefinitionGroup(writer, "Release", "ARM64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
                WriteItemDefinitionGroup(writer, "Diagnostics", "ARM64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
                WriteItemDefinitionGroup(writer, "SimulationOnly", "ARM64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
                WriteItemDefinitionGroup(writer, "TraceOnly", "ARM64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
                WriteItemDefinitionGroup(writer, "MetricsOnly", "ARM64", "/DTWMETRICS_ENABLE", "", "$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWServerLibLin.a;$(RemoteRootDir)/$(SolutionName)/lib/$(Platform)/$(Configuration)/libTWCoreLibMac.a", "", "", false);
